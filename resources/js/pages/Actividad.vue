      ...
      <b-col cols="12" md="6" class="p-md-5 p-2">
        <b-card>
          <form @submit.prevent="submit">
            ...
            <hr />
            <b-button v-if="user" type="submit" variant="info">Reservar</b-button>
            <b-button to="/ingresar" v-else type="button" variant="secondary" @click="registrar">Registrate</b-button>
          </form>
        </b-card>
      </b-col>
      <b-col cols="12">
